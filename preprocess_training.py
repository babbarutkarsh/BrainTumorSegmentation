...
for patient in range(len(folder_paths)):
    ...
    np.save("{}/{}/{}_scans".format(save_preprocessed_data_path,data_id, data_id), X)
    if train_data:
        #np.savez_compressed("{}/{}/{}_mask".format(save_preprocessed_data_path, data_id, data_id), img_seg)
        np.save("{}/{}/{}_mask".format(save_preprocessed_data_path, data_id, data_id), img_seg)
